...
int32_t main(const int32_t argc, const char** argv)
{
  ...
  {
    {
      auto byValue = [](int32_t num) { cout << "[byValue function] : " << ++num << endl; };
      auto bylValueRef = [](int32_t& num) { cout << "[bylValue function] : " << ++num << endl; };
      auto byrValueRef = [](int32_t&& num) { cout << "[byrValue function] : " << ++num << endl; };
